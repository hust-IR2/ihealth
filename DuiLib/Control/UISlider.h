...
namespace DuiLib
{
	...
	public:
		...
		void SetForeWidth(DWORD dwWidth);
		void SetBkWidth(DWORD dwWidth);
		void SetBkHeight(DWORD dwHeight);
		void SetThumbWidth(DWORD dwWidth);
		void SetThumbHeight(DWORD dwHeight);
		...
		virtual void PaintThumbImage(HDC hDC);
	protected:
		SIZE m_szThumb;
		UINT m_uButtonState;
		int m_nStep;
